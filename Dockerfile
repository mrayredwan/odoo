...
EXPOSE 8069
CMD ["python3", "odoo-bin", "--workers=3", "--limit-memory-soft=268435456", "--limit-memory-hard=3221225472", "--limit-time-cpu=60", "--limit-time-real=120", "--proxy-mode", "--longpolling-port=8072"]
